            ...
            <CartProvider>
              ...
              <footer className="bg-gray-900 py-8 text-white">
                <div className="container mx-auto grid grid-cols-1 gap-8 px-4 md:grid-cols-4">
                  <div>
                    <h3 className="mb-4 text-xl font-bold">PadelGoats</h3>
                    <p className="text-gray-300">Tienda especializada en paletas de padel de las mejores marcas.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li><Link href="/productos" className="text-gray-300 hover:text-white">Paletas</Link></li>
